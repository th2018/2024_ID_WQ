...
# Step 1: gage ID
```{r}
st_all_gage<-c("13150430")    # 13337099, 12413370, 13311450, 13213000, 13341050, 13139510, 13018300, 13211205
#,13266000, 14219800, 14205350, 12179900, 14046778,14152500
#,13296000, 12398600, 13307000, 13337099
#, 13311000, 13340600 , 12305000, 13342500, 13016450, 13092747, 13310800, 13192200,13317660, 12322000, 13341000 (no Q), 13333000 (no ST)
#https://waterdata.usgs.gov/monitoring-location/13266000/#parameterCode=00065&period=P7D&showMedian=false

summer=c(6,7,8)

#  calculates a minimum number of days
