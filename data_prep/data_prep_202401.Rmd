...
# Step 1: gage ID
```{r}
st_all_gage<-c("13150430") # 13150430, 12413370,  13266000, 13311000, 13340600, 13092747, 12305000, 13342500
...
plot(prism_df_positive$tmean..degrees.C., prism_df_positive$X_00010_00003, xlim = lim,ylim=lim )
