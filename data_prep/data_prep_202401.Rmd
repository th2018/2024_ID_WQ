...
# Step 1: gage ID
```{r}
st_all_gage<-c("13296000") # 13150430, 12413370
#,13266000
#,13296000
#, 13311000, 13340600, 13092747, 12305000, 13342500
...
```{r}
prism_df_positive_17_20<- prism_df_positive[prism_df_positive$yr %in% c("2017","2020"),]
lim=c(0, max(prism_df$tmean..degrees.C.)+1 )
plot( prism_df_positive_17_20$tmean..degrees.C.,  prism_df_positive_17_20$X_00010_00003, xlim = lim,ylim=lim, col=prism_df_positive$yr )
summary(lm(   prism_df_positive_17_20$X_00010_00003 ~ prism_df_positive_17_20$tmean..degrees.C.  ))
```
