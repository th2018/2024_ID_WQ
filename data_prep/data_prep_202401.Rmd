...
# Step 1: gage ID
```{r}
st_all_gage<-c("13139510") # 13150430, 12413370, 13311450, 13213000, 13341050, 13139510, 
#,13266000
#,13296000
...
lim=c(0, max(prism_df$tmean..degrees.C.)+1 )
plot( prism_df_positive_17_20$tmean..degrees.C.,  prism_df_positive_17_20$X_00010_00003, xlim = lim,ylim=lim, col=prism_df_positive_17_20$yr )
