...
# Step 1: gage ID
```{r}
st_all_gage<-c("12398600") # 13150430, 12413370, 13311450, 13213000, 13341050, 13139510, 13018300, 13211205
...
boxplot(   (   prism_df_summer$X_00010_00003/prism_df_summer$tmean..degrees.C. ) ~ prism_df_summer$yr)
